...
<div class="layout">
  ...
  <main class="content">
    <section class="contact-shell contact-flush">
      <div class="contact-split">

        <!-- Left: full-height image -->
        <div class="contact-media">
          <!-- Use your Figma tram photo file here -->
          <img src="./images/contact-side.jpg" alt="Contact visual"
               onerror="this.src='https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=1600&auto=format&fit=crop'">
        </div>

        <!-- Right: plain text + form (no card) -->
