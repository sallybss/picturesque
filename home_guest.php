<?php
// home_guest.php — public home (no login required)
...
<div class="layout">
  <?php
    // Guest sidebar: show Home/About/Contact + Login/Register; hide profile/admin/settings
    render_sidebar([
      'isAdmin'  => false,
      'isGuest'  => true,
  ...
  <main class="content">
    ...
    <!-- Fade + CTA gate (sticky at bottom of viewport like Figma) -->
    <div class="guest-gate">
      <div class="guest-fade"></div>
      <div class="gate-card">
        <div class="gate-star">⭐</div>
        <p class="gate-text">To have full access to the gallery, please log in or create an account.</p>
        <div class="gate-actions">
          <a class="btn-primary" href="./auth/register.php">Register</a>
          <a class="btn-ghost" href="./auth/login.php">Sign in</a>
        </div>
      </div>
    </div>
  </main>
