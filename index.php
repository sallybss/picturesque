...
<style>
/* Sort dropdown (inline so we know it loads) */
...
.filter-select{
  ...
  padding:10px 40px 10px 14px; font-size:14px; font-weight:600;
  color:var(--text); cursor:pointer; box-shadow:0 2px 6px rgba(0,0,0,.05);
  transition:all .25s ease
}
.filter-select:hover{background:#f9fafb;border-color:#cbd5e1;transform:translateY(-1px)}
.filter-select:focus{outline:none;border-color:var(--primary);box-shadow:0 0 0 3px rgba(142,198,223,.35)}
